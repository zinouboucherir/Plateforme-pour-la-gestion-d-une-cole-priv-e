...
class AdminEmploiController extends Controller {
    ...
    {        
        $emploiManager=new EmploiDuTempsManager();
        $emploiManager->updateEmploi($_POST['id'],$_POST['jour'],$_POST['t1'],$_POST['t2'],$_POST['t3'],$_POST['t4'],$_POST['t5'],$_POST['t6'],$_POST['t7'],$_POST['t8'],$_POST['t9'],$_POST['cycle'],$_POST['classe']);
        $emplois =  $emploiManager->getEmploi();
        $params = [
            'emplois' =>  $emplois,
        ];
