...
namespace app\views;
class ensSecondaire{
public function ensSecondairebody($ens){
?>
<section><div class="jumbotron page" id="page1">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>La liste des enseignants du cycle<b> secondaire</b></h2>
					</div>
				</div>
			</div>
...
public function afficher_ensSecondaire($ens){
    ?>
    <!DOCTYPE html>
    <html lang="en">
    <?php
