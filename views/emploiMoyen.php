...
namespace app\views;
class emploiMoyen{
public function emploiMoyenbody($emplois){
?>
<br/>
<section>
<div class="jumbotron page" id="page1">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>Les emplois du temps du cycle<b> moyen</b></h2>
					</div>
				</div>
			</div>
...
public function afficher_emploiMoyen($emplois){
    ?>
    <!DOCTYPE html>
    <html lang="en">
    <?php
